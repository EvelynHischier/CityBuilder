...
<!--   number > hover 
	...
	<table id="tableGame">
		<tbody>
			...
			<tr>
				<td class="citizen" id="table_priest" colspan="3"  data-ng-mouseover="hoverGame('priest')" data-ng-bind="textGamePriest"></td>
				<td class="number"><input type="number" id="txt2" value="1" min="0" onBlur="updatePyramid()"/></td>
			</tr>
			<tr>
				<td class="citizen" id="table_craftsment"  colspan="3"  data-ng-mouseover="hoverGame('craftsmen')"  data-ng-bind="textGameCraft"></td>
				<td class="number"><input type="number" id="txt3" value="1" min="0" onBlur="updatePyramid()"/></td>
			</tr>
			<tr>
				<td class="citizen" id="table_scribes" colspan="3"  data-ng-mouseover="hoverGame('scribes')" data-ng-bind="textGameScribes"></td>
				<td class="number"><input type="number" id="txt4" value="1" min="0" onBlur="updatePyramid()"/></td>
			</tr>
			<tr>
				<td class="citizen" id="table_soldiers" colspan="3"  data-ng-mouseover="hoverGame('soldier')" data-ng-bind="textGameSoldiers" ></td>
				<td class="number"><input type="number" id="txt5" value="1" min="0" onBlur="updatePyramid()"/></td>
			</tr>
			<tr>
				<td class="citizen" id="table_peasants" colspan="3"  data-ng-mouseover="hoverGame('peasants')" data-ng-bind="textGamePeasants"></td>
				<td class="number"><input type="number" id="txt6" value="1" min="0" onBlur="updatePyramid()"/></td>
			</tr>
			<tr>
				<td class="citizen" id="table_slaves" colspan="3"  data-ng-mouseover="hoverGame('slaves')" data-ng-bind="textGameSlaves"></td>
			...
			<tr>
				...
				<td class="number"><input type="number" id="caravans" value="0" min="0" onBlur="updatePyramid()" readonly="readonly"/></td>
			</tr>
