...
<!-- 			Wealth -->
				...
				<td class="scoreNumber">
					<input type="text" id="table_wealth_number" readonly="readonly" 
					data-ng-value="scoreWealth" data-ng-mouseover="hoverScore('wealth')">
				</td>
			</tr>
			<tr>
<!-- 			Buildings -->
				...
				<td class="scoreNumber">
					<input type="text" id="table_buildings_number" readonly="readonly" 
					data-ng-value="scoreBuildings" data-ng-mouseover="hoverScore('buildings')">
				</td>
			</tr>
			<tr>
<!-- 			Population -->
...
<!-- 			Happiness -->
				...
				<td class="scoreNumber">
					<input type="text" id="table_happyness_number" readonly="readonly" 
					data-ng-value="scoreHappyness" data-ng-mouseover="hoverScore('happiness')">
				</td>
			</tr>
...
<!-- 			Total -->
				...
				<td class="scoreNumber">
					<input type="text" id="table_total_number" readonly="readonly" 
					data-ng-value="scoreTotal" data-ng-mouseover="hoverScore('total')">
				</td>
			</tr>
		</tbody>
