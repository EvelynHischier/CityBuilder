		...
		<tbody>
			<tr>
				...
				<td class="tech" data-ng-bind="textGameWriting"
					data-ng-click="clickTechnologie('writing')"  data-ng-disabled="enableButton"></td>
				<td class="tech" data-ng-bind="textGameGranary"
					data-ng-click="clickTechnologie('granary')" data-ng-disabled="enableButton"></td>
				<td class="tech" data-ng-bind="textGamePottery"
					data-ng-click="clickTechnologie('pottery')" data-ng-disabled="enableButton"></td>
			</tr>
			<tr>
